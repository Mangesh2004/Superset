...
export class Theme {
  ...
  private static readonly defaultTokens = {
    ...
    // Default colors - Professional White + Purple + Gray Theme
    colorPrimary: '#8B5CF6', // Beautiful purple for professional look
    colorLink: '#8B5CF6',
    colorError: '#EF4444',  // Modern clean red
    colorWarning: '#F59E0B', // Modern clean amber
    colorSuccess: '#10B981', // Modern clean green
    colorInfo: '#3B82F6',   // Modern clean blue
    
    // Professional Background Colors
    colorBgBase: '#FFFFFF',          // Pure white main background
    colorBgContainer: '#F8FAFC',     // Light gray for cards/panels
    colorBgElevated: '#FFFFFF',      // White for modals/dropdowns
    colorBgLayout: '#FFFFFF',        // White page background
    colorBgSpotlight: '#F3F4F6',     // Slightly darker gray for highlights
    
    // Border Colors with Purple Accents
    colorBorder: '#8B5CF6',          // Purple borders for cards
    colorBorderSecondary: '#A78BFA', // Lighter purple for subtle borders
    colorPrimaryBorder: '#8B5CF6',   // Purple for focused/active borders
    colorPrimaryBorderHover: '#7C3AED', // Purple hover borders
    colorSplit: '#E5E7EB',           // Divider lines
    
    // Professional Text Colors
    colorText: '#111827',            // Dark gray text (not black)
    colorTextSecondary: '#6B7280',   // Medium gray
    colorTextTertiary: '#9CA3AF',    // Light gray
    colorTextLabel: '#374151',       // Form labels
    colorTextDescription: '#6B7280', // Descriptions
    colorTextPlaceholder: '#9CA3AF', // Input placeholders
    colorTextHeading: '#111827',     // Headings
    
    // Component Fill Colors
    colorFill: '#F9FAFB',            // Light fill
    colorFillSecondary: '#F3F4F6',   // Medium fill
    colorFillContent: '#F8FAFC',     // Content areas
    colorFillAlter: '#F9FAFB',       // Alternative fills
    
    // Interactive States
    colorBgTextHover: '#F9FAFB',     // Text hover background
    colorControlItemBgHover: '#F3F4F6', // List item hovers
    colorControlItemBgActive: '#EDE9FE', // Purple-tinted active state
    colorPrimaryHover: '#7C3AED',    // Darker purple on hover
    colorPrimaryActive: '#6D28D9',   // Even darker on click
    
    // Modern Design Tokens
    borderRadius: 16,                // More rounded corners for cards
    borderRadiusLG: 20,             // Large components more rounded
    borderRadiusSM: 12,             // Small components more rounded
