...
const StyledCard = styled(Card)`
  ${({ theme }) => `
    overflow: hidden;
    border-radius: 16px; /* More rounded borders for modern look */
    border: 2px solid ${theme.colorBorder}; /* Purple border for all cards */
    ...
    &:hover {
      ...
      transition: all ${theme.motionDurationSlow} ease-in-out;
