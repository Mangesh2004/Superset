...
export const CardContainer = styled.div<{
  ...
  ${({ showThumbnails, viewMode = 'grid', density = 'comfortable', theme }) => `
    overflow: visible;
    ...
    gap: ${
      density === 'compact' ? theme.sizeUnit * 6 : 
      density === 'spacious' ? theme.sizeUnit * 16 : 
      theme.sizeUnit * 12
    }px;
    
    /* Remove fixed height constraint for better content flow */
    max-height: unset;
    min-height: ${showThumbnails ? '400' : '200'}px;
    
    /* Better responsive behavior */
    margin-top: ${theme.sizeUnit * -6}px;
    padding: ${
      showThumbnails
        ? `${theme.sizeUnit * 8 + 3}px ${
            density === 'compact' ? theme.sizeUnit * 12 : 
            density === 'spacious' ? theme.sizeUnit * 28 : 
            theme.sizeUnit * 20
          }px`
        : `${theme.sizeUnit * 8 + 1}px ${
            density === 'compact' ? theme.sizeUnit * 12 : 
            density === 'spacious' ? theme.sizeUnit * 28 : 
            theme.sizeUnit * 20
          }px`
...
export const CardStyles = styled.div`
  ...
  .ant-card {
    border: 2px solid ${({ theme }) => theme.colorBorder}; /* Purple borders for all cards */
    border-radius: 16px;
...
export const OverviewSection = styled.div`
  ...
  gap: ${({ theme }) => theme.sizeUnit * 6}px;
  margin-bottom: ${({ theme }) => theme.sizeUnit * 8}px;
...
export const StatCard = styled.div`
  ...
  border: 2px solid ${({ theme }) => theme.colorBorder}; /* Thicker purple border */
  border-radius: 16px; /* More rounded for a modern look */
  padding: ${({ theme }) => theme.sizeUnit * 6}px;
  text-align: center;
  transition: all 0.2s ease;
  ...
  &:hover {
    border-color: ${({ theme }) => theme.colorPrimary};
    box-shadow: 0 4px 12px rgba(139, 92, 246, 0.2); /* Purple shadow on hover */
  }
...
export const ViewToggle = styled.div`
  ...
  button {
    ...
    border: none;
    padding: ${({ theme }) => theme.sizeUnit * 2}px ${({ theme }) => theme.sizeUnit * 3}px;
    cursor: pointer;
    color: ${({ theme }) => theme.colorTextSecondary};
    transition: all 0.2s ease;
