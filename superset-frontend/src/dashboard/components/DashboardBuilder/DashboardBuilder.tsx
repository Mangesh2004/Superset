...
const DashboardContentWrapper = styled.div`
  ${({ theme }) => css`
    ...
    /* Chart holder styling for both edit and view modes */
    .dashboard-component-chart-holder {
      border: 2px solid ${theme.colorBorder}; /* Purple border for all chart cards */
      border-radius: 16px; /* Rounded corners */
      background: ${theme.colorBgElevated}; /* White background */
      transition: all 0.2s ease; /* Smooth transitions */
      overflow: hidden; /* Ensure content doesn't overflow rounded corners */
      margin: ${theme.sizeUnit * 2}px; /* Add some spacing between charts */
      
      &:hover {
        border-color: ${theme.colorPrimary}; /* Darker purple on hover */
        box-shadow: 0 4px 12px rgba(139, 92, 246, 0.2); /* Purple shadow */
      }
    }
    ...
    &.dashboard--editing {
      ...
      .dashboard-component-chart-holder {        
        &:after {
          ...
          z-index: 1;
          pointer-events: none;
          border: none; /* Remove extra border from :after in edit mode */
        }

        &:hover {
          /* Additional edit mode hover effects */
          border-color: ${theme.colorPrimary}; /* Ensure hover still works */
        }
        
        &:hover:after {
          border: none; /* Remove dashed border, use main border instead */
          z-index: 2;
        }
      }
